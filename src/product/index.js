...
function ProductPage() {
  ...
  useEffect(function () {
    getProduct();//useEffect시 getProduct 랜딩될때 부르고 
  }, []);
  ...
  return (
    <div>
      ...
      <div id="contents-box">
        ...
        <Button id="purchase-button" size="large" type="primary" danger onClick={onClickPurchase} disabled={product.soldout === 1}>재빨리 구매하기</Button>
